...
const textData = {
    ...
    void_tut_desc: {en_us: 'The Void rune grants control\nof the power of dark emptiness.\nVoid spells can deal percentage\nhealth damage, fully negate\nenemy attacks, or even completely\nheal you, but at a cost.',
        fr: '',
        zh_cn: '',
        ru: '',
        es: '',
        jp: ''},
    void_tut_strike_desc: {en_us: 'An attack that deals %health\ndamage and deals that damage\nagain 2 more times after\na delay.',
        fr: '',
        zh_cn: '',
        ru: '',
        es: '',
        jp: ''},
    void_tut_enhance_desc: {en_us: 'Curses an enemy, causing them\nto take more damage from all\nsources. Works well with\nother spells that deal damage\nmultiple times.',
        fr: '',
        zh_cn: '',
        ru: '',
        es: '',
        jp: ''},
    void_tut_protect_desc: {en_us: 'Creates a shield that fully\nnegates all damage from an\nattack, no matter how strong.',
        fr: '',
        zh_cn: '',
        ru: '',
        es: '',
        jp: ''},
    void_tut_reinforce_desc: {en_us: 'Fully heals you, but at the\ncost of a portion of your\nmaximum health.',
        fr: '',
        zh_cn: '',
        ru: '',
        es: '',
    ...
    protect_tut_desc: {en_us: 'The Shield rune lets you\ncreate shields for protection\nyou as long as they are\nswiveled in between you and\nharm\'s way.',
        fr: '',
        zh_cn: '',
        ru: '',
        es: '',
        jp: ''},
    reinforce_tut_desc: {en_us: 'The Body rune enhances your\nbody with effects that last\nuntil you cast a different\nbody spell. With the right\nrune combo, the Body rune\ncan even heal you.',
        fr: '',
        zh_cn: '',
        ru: '',
        es: '',

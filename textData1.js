...
let textData = {
    ...
    "time_unload_desc_long": {
        "en_us": "Freeze time for next ",
        "fr": "Gèle le temps pour ",
        "zh_tw": "為接下來 ",
        "zh_cn": "为接下来 ",
        "ru": "Заморозьте время на следующие ",
    ...
    "time_unload_desc_long_full": {
        "en_us": "Freeze time for next 7 spells.\nWeakens with repeat use.",
        "fr": "Gèle le temps pour 7 prochains sorts.\nS'affaiblit avec une utilisation répétée.",
        "zh_tw": "為接下來 7 個法術\n凍結時間。重複使用會變弱。",
        "zh_cn": "为接下来 7 个法术\n冻结时间。重复使用会变弱。",
    ...
    "mind_protect_desc_long": {
        "en_us": "Create shield that reflects\n50% of next enemy attack",
        "fr": "Créez bouclier qui reflète\n50% de la prochaine attaque ennemie.",
        "zh_tw": "創建一個盾牌，反射\n50% 的下一次敵人攻擊",
        "zh_cn": "创建一个盾牌，反射\n50% 的下一次敌人攻击",
    ...
    "time_tut_desc": {
        "en_us": "Time Rune controls the flow\nof time. Time spells let you\nattack multiple times, defer damage,\nor slow your enemies to a crawl.",
    ...
    "time_tut_desc_sh": {
        "en_us": "Time Rune controls the flow\nof time. Time spells let you\nattack multiple times, defer\ndamage, or slow your enemies\nto a crawl.",
        "fr": "La Rune du Temps accorde le\ncontrôle du temporel. Les sorts\ntemporels vous permettent d'attaquer\nplusieurs fois, de différer les\ndégâts ou de geler vos ennemis.",
        "zh_tw": "時間符文授予對時間的控\n制權。時間法術讓你能多次\n攻擊，延緩受傷時間，甚至\n凍結時間來減慢敵人的行動。",
        "zh_cn": "时间符文授予对时间的控\n制权。时间法术让你能多次\n攻击，延缓受伤时间，甚至\n冻结时间来减慢敌人的行动。",
        "ru": "Руна Времени предоставляет\nконтроль над самим временем.\nЗаклинания Времени позволяют вам атаковать\nнесколько раз, откладывать урон или\nзамедлять ваших врагов до предела.",
        "es": "La runa del tiempo otorga control sobre lo temporal. Los hechizos de tiempo te permiten atacar varias veces, retrasar las lesiones o incluso ralentizar a tus enemigos hasta detenerlos.",
    ...
    "unload_tut_desc": {
        "en_us": "Ultimate rune grants you some\nof the most powerful spells\nin your arsenal. Use this\nrune wisely.",

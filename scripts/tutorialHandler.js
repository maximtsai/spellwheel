function buildTutorialMatter() {
    ...
    globalObjects.runePicture.setFrame('rune_matter_large.png');
    ...
    let tutRune = PhaserScene.add.sprite(gameConsts.halfWidth - 200, gameConsts.halfHeight - 190, 'tutorial', 'rune_matter_large.png').setScale(0.96).setAlpha(0.5).setDepth(10001);
    ...
    let runeClicker2 = buildRuneclicker(tutRune2.x, tutRune2.y, () => {
        ...
        globalObjects.runePicture.setFrame('tut_matter_strike.png');
    ...
    let runeClicker3 = buildRuneclicker(tutRune3.x, tutRune3.y, () => {
        ...
        globalObjects.runePicture.setFrame('tut_matter_enhance.png');
    })

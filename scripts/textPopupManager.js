class TextPopupManager {
    constructor(scene) {
        ...
        this.infoText = this.scene.add.text(0, 0, 'WELCOME', {fontFamily: 'Times New Roman', fontSize: 22, color: '#FFFFFF', align: 'center'}).setAlpha(0).setOrigin(0.5, 0.5).setDepth(100001);

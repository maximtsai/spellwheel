 class LesserDummy extends Enemy {
    ...
    attemptTutThree() {
     ...
     showVictory() {
         ...
         let continueText = this.addText(gameConsts.halfWidth, gameConsts.halfHeight + 2, getLangText('cont_ui'), {fontFamily: 'Verdana', color: '#F0F0F0', fontSize: 18}).setAlpha(0).setOrigin(1, 0.5).setAlign('right').setDepth(9998);

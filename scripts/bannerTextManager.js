class BannerTextManager {
    constructor(scene) {
        ...
        this.text = this.scene.add.text(gameConsts.halfWidth, this.textBG.y - 4, '...', {fontFamily: 'garamondmax', fontSize: 32, color: '#FFFFFF', align: 'center'}).setAlpha(0).setOrigin(0.5, 0.6).setDepth(100002);

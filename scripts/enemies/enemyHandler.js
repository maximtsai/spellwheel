function createEnemy(num) {
    ...
    case 1:
        ...
        break;
    case 2:
        globalObjects.currentEnemy = new Goblin(PhaserScene, gameConsts.halfWidth, 179, num);
        break;
    case 3:
    ...
    case 5:
        ...
        break;
    case 6:
        globalObjects.currentEnemy = new Wall(PhaserScene, gameConsts.halfWidth, 173, num);
        break;
    case 7:
    ...
    case 12:
        break;
    default:
        globalObjects.currentEnemy = new Goblin(PhaserScene, gameConsts.halfWidth, 179);
        break;

...
const textData = {
    ...
    // ================== Tutorial ================
    matter_tut_desc: {en_us: 'The Matter rune represents\nall that is physical.\nThis rune provides direct\nabilities to either deal or\nprotect against damage.',
        fr: '',
        zh_cn: '',
        ru: '',
        es: '',
        jp: ''},
    matter_tut_strike_desc: {en_us: 'Conjure a ball of rock\nthat deals raw damage.\nSimple but effective.',
        fr: '',
        zh_cn: '',
        ru: '',
        es: '',
    ...
    time_tut_protect_desc: {en_us: 'Creates a shield that delays\nall damage you take to a\nslow trickle, but only up\nto a limit.',
        ...
        es: '',
        jp: ''},
    time_tut_reinforce_desc: {en_us: 'Recovers',
        fr: '',
        zh_cn: '',
        ru: '',
        es: '',
        jp: ''},
    time_tut_ultimate_desc: {en_us: 'Multiplies the effectivness\nof your next non-attack\nspell.\nSupposedly it\'s possible to\ncast this spell twice in\na row for additional power.',
        fr: '',
        zh_cn: '',
        ru: '',
        es: '',

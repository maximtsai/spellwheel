 class Magician extends Enemy {
    constructor(scene, x, y, level) {
     ...
     showRune() {
         ...
         let continueText = PhaserScene.add.text(gameConsts.halfWidth, gameConsts.halfHeight + 2, getLangText('cont_ui'), {fontFamily: 'Verdana', color: '#F0F0F0', fontSize: 20}).setAlpha(0).setOrigin(1, 0.5).setAlign('right').setDepth(9998);

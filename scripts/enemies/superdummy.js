 class SuperDummy extends Enemy {
    constructor(scene, x, y, level) {
     ...
     initMisc() {
        ...
        this.stars = this.scene.add.sprite(this.x - 5, this.y - 96, 'enemies', 'super_dummy_stars.png').setOrigin(0.5, 0.5).setScale(this.sprite.startScale * 0.7).setDepth(150).setAlpha(0);
    ...
    showFalseVictory() {
        ...
        PhaserScene.tweens.add({
            ...
            duration: 500,
            onComplete: () => {
                let dummyArm = this.scene.add.sprite(this.x - 95, this.y - 70, 'enemies', 'super_dummy_rightarm_stretch.png').setScale(0, 0.15).setDepth(-1);
                setTimeout(() => {
                    playSound('balloon', 0.8)
                }, 300);
                PhaserScene.tweens.add({
                     targets: dummyArm,
                     scaleX: 1,
             ...
             onComplete: () => {
                 this.currAnim = PhaserScene.tweens.add({
                     ...
                     onComplete: () => {
                        ...
                        this.bgMusic = playSound('and_into_the_void', 0.1, true);
                        this.setDefaultSprite('dummy_angry.png');
                        this.dummyRightArm = this.scene.add.sprite(this.x + 51, this.y + 30, 'enemies', 'super_dummy_rightarm.png').setScale(this.sprite.startScale * 0.4).setDepth(-1).setRotation(0.5);
                        this.dummyLeftArm = this.scene.add.sprite(this.x - 51, this.y + 30, 'enemies', 'super_dummy_leftarm.png').setScale(this.sprite.startScale * 0.4).setDepth(-1).setRotation(-0.5);
    ...
    buffUp() {
     ...
     createPunchEffect() {
        ...
        playSound(isSwingingLeft ? 'punch' : 'punch2');
         ...
         let fistEffect = getTempPoolObject('enemies', 'super_dummy_fist.png', 'fist', 250);
         ...
         let starEffect = getTempPoolObject('enemies', 'super_dummy_stars.png', 'stars', 250);
    ...
    buffOneArm(arm, rotMult = 1) {
     ...
     createDoublePunchEffect() {
        ...
        setTimeout(() => {
         ...
         let fistEffect = getTempPoolObject('enemies', 'super_dummy_fist.png', 'fist', 250);
         let fistEffect2 = getTempPoolObject('enemies', 'super_dummy_fist.png', 'fist', 250);
